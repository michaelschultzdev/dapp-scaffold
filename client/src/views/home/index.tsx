	...
	return (
		<div className='md:hero mx-auto p-4'>
			<div className='md:hero-content flex flex-col'>
				...
				<div className='mx-auto flex gap-10 bg-white/5 px-6 ring-1 ring-white/10 sm:rounded-3xl lg:mx-0 lg:max-w-none flex-col lg:items-center py-10 lg:pt-16 lg:pb-20 xl:gap-x-20 xl:px-20'>
